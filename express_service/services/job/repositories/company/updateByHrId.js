...
const UpdateCompanyByHrId = async (hrId, data, transaction = null) => {
  try {
    // Find the company by ID
    const company = await Company.findOne({ where: { hrId: hrId }, transaction });
...
module.exports = UpdateCompanyByHrId;
